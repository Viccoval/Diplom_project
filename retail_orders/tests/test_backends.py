...
class ContactViewSetTest(APITestCase):
    ...
    def test_create_contact_authenticated(self):
        ...
        self.assertEqual(response.status_code, status.HTTP_201_CREATED)
        new_contact = Contact.objects.get(phone='+1-987-654-321')
...
class OrderViewSetTest(APITestCase):
    ...
    def test_add_to_cart_success(self):
        ...
        self.assertTrue(OrderItem.objects.filter(order__user=self.user, product=self.product, quantity=2).exists())
