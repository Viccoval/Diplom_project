"""
Django settings for retail_orders project.
...
SECRET_KEY = 'django-insecure-hxe6+6&vbj1*=7qsqi6oej-tghm%1fxkux-c(@9l51)s#e-h(l'
...
SPECTACULAR_SETTINGS = {
    ...
    'DESCRIPTION': 'API для интернет-магазина (retail orders)',
    'VERSION': '1.0.0',
